...
export const Hero: React.FC<HeroProps> = ({ onNavigate }) => {
  const stats = [
    { icon: <TrendingUp size={32} />, value: '+30%', label: 'ROI Increase' },
    { icon: <BarChart3 size={32} />, value: '95%', label: 'Retention' },
    { icon: <Zap size={32} />, value: '2.5X', label: 'Growth Rate' },
  ];
  ...
  return (
    <section className="relative min-h-screen w-full flex flex-col justify-center items-center overflow-hidden pt-32 pb-24 px-6">
      ...
      <div className="relative z-20 w-full max-w-[1440px] mx-auto text-center flex flex-col gap-16 md:gap-24">
        ...
        >
          <h1 className="text-white text-6xl md:text-8xl lg:text-[10rem] font-heading font-bold leading-[0.85] tracking-tight uppercase">
          ...
          <p className="text-gray-400 text-lg md:text-xl font-body font-light leading-relaxed max-w-3xl mx-auto tracking-wide">
