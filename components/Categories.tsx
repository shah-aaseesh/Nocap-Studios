  ...
  return (
    <section className="py-24 bg-background-dark relative" id="expertise">
      <div className="max-w-[1440px] mx-auto px-6 md:px-12 lg:px-24">
        ...
        >
          <span className="text-primary text-xs font-bold uppercase tracking-[0.2em]">Our Expertise</span>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 lg:grid-rows-2 gap-6 h-auto lg:h-[900px]">
          {CATEGORIES.map((cat, idx) => (
            <motion.div
              ...
              className={`group relative overflow-hidden border border-white/10 hover:border-primary/50 transition-colors duration-500 ${cat.gridSpan}`}
            >
              <div
              ...
              <div className="absolute bottom-0 left-0 p-8 md:p-12 w-full">
                <div className="flex items-center gap-3 mb-4 text-primary opacity-0 -translate-y-4 group-hover:opacity-100 group-hover:translate-y-0 transition-all duration-500 delay-100">
                  ...
                  <span className="text-sm font-bold uppercase tracking-wider">Strategic Sector</span>
                </div>
                <h3 className="text-4xl md:text-6xl font-heading font-bold text-white mb-4 uppercase leading-none">
                  {cat.title}
                </h3>
                <p className="text-gray-400 max-w-md text-sm md:text-base leading-relaxed opacity-80 group-hover:opacity-100 transition-opacity">
                  {cat.description}
                </p>
              </div>
            </motion.div>
